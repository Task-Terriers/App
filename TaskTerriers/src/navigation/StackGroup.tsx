...
import SettingsTabAboutScreen from '../Screens/SettingsTabScreen/SettingsTabAboutScreen'
...
const StackGroup = () => {
  return (
    <Stack.Group screenOptions={{ headerShown: false }}>
      ...
      <Stack.Screen name="SettingsTabAboutScreen" component={SettingsTabAboutScreen} />
    </Stack.Group>
  )
}
